        ...
        html.Div(
            ...
            ['Select a date range: ',
             dcc.DatePickerRange(
                 ...
                 style={'font-size': '18px', 'display': 'inline-block', 'align': 'center', 'border-radius': '2px',
                        'border': '1px solid #ccc', 'color': '#333', 'border-spacing': '0', 'border-collapse': 'separate'}
             ),
             html.Div(id='output-container-date-picker-range',
                      children='You have selected a date')

             ]),
        html.Div([
            # Stock price button
            html.Button('Stock Price', id='submit-val', n_clicks=0, style={
                        'float': 'left', 'padding': '15px 32px', 'background-color': 'red', 'display': 'inline'}),
            ...
            html.Button('No of days to forcast',
                        id='submit-forc', n_clicks=0),
            html.Div(id='forcast')
            # Forecast button
        ])
    ], className='nav'),
